...
async function closeShift(businessId, userId, id, { actualCash, notes }) {
  ...
  // Every cash payment recorded against this shift (sale payments AND
  // standalone customer credit payments both carry shiftId) is what's
  // expected to be sitting in the drawer on top of the opening float.
